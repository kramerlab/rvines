...
import weka.estimators.vines.copulas.Gumbel180RotatedCopula;

public class Gumbel180CopulaTest extends TestCase {
	...
	public void testCDF(){
		...
		Gumbel180RotatedCopula c = new Gumbel180RotatedCopula(new double[]{sign*2});
